    ...
    <div class="flex justify-center">
      ...
      >
        <p>
          ...
          Phaltz, the owner and provider of this Website. Phaltz takes the
        ...
        <div class="flex items-center my-4">
          ...
          <div class="w-4/5 ml-6">
            collectively all personal information that you submit to Phaltz via
        ...
        <div class="flex items-center my-4">
          <div class="w-1/5 mr-6"><span class="font-bold">Cookies</span>:</div>
          <div class="w-4/5 ml-6">
        ...
        <div class="flex items-center my-4">
          ...
          <div class="w-4/5 ml-6">
            ...
            Phaltz and accessing the Website in connection with the provision of
            such services; and
          </div>
        </div>

        <div class="flex items-center my-4">
          <div class="w-1/5 mr-6"><span class="font-bold">Website</span>:</div>
          <div class="w-4/5 ml-6">
        ...
        <ol>
          ...
          <li class="my-6">
            5. reference to any statutory provision includes any modification or
            amendment of it;
          </li>
        ...
        <p>
          ...
          with respect to this Website. It does not extend to any websites that
          can be accessed from this Website including, but not limited to, any
          links we may provide to social media websites. For purposes of the
          applicable Data Protection Laws, Phaltz is the "data controller". This
          means that Phaltz determines the purposes for which, and the manner in
        ...
        <ol>
          <li class="my-6">
            1. we automatically collect some information about your visit to the
          ...
          <li class="my-6">
            2. we will collect your Data automatically via cookies, in line with
        ...
        <p class="mt-4">
          in each case, in accordance with this privacy policy. We may use your
          Data for the above purposes if we deem it necessary to do so for our
          legitimate interests. If you are not satisfied with this, you have the
          right to object in certain circumstances (see the section headed "Your
          rights" below). When you register with us and set up an account to
          receive our services, the legal basis for this processing is the
        ...
        <ol>
          ...
          <li class="my-6">2. we store your Data on secure servers.</li>
        </ol>
        <p class="mt-4">
        ...
        <p>
          ...
          request that the Data be deleted. Even if we delete your Data, it may
        ...
        <ol>
          ...
          <li class="my-6">
            2. Right to correct - the right to have your Data rectified if it is
          ...
          <li class="my-6">
            4. Right to restrict our use of your Data - the right to "block" us
        ...
        <p class="mt-4">
          ...
          e-mail address: info@phaltz.com. If you are not satisfied with the way
          ...
          https://ico.org.uk/. It is important that the Data we hold about you
          is accurate and current. Please keep us informed if your Data changes
        ...
        <p>
          Phaltz may, from time to time, expand or reduce our business and this
          may involve the sale and/or the transfer of control of all or part of
          Phaltz. Data provided by Users will, where it is relevant to any part
        ...
        <p>
          ...
          ensure that your privacy is protected and respected at all times. All
          Cookies used by this Website are used in accordance with current UK
          and EU Cookie Law. Before the Website places Cookies on your computer,
          you will be presented with a message bar requesting your consent to
          set those Cookies. By giving your consent to the placing of Cookies,
          you are enabling Phaltz to provide a better experience and service to
        ...
        <p>
          ...
          internet browser. You can choose to delete Cookies at any time;
          ...
          personalisation settings. It is recommended that you ensure that your
          internet browser is up-to-date and that you consult the help and
          guidance provided by the developer of your internet browser if you are
          unsure about adjusting your privacy settings. For more information
        ...
        <p>
          ...
          where we reasonably believe your rights will not be affected. If any
          court or competent authority finds that any provision of this privacy
          ...
          other, right or remedy. This Agreement will be governed by and
          interpreted according to the law of England and Wales. All disputes
        ...
        <p>
          Phaltz reserves the right to change this privacy policy as we may deem
          ...
          Website following the alterations. You may contact Phaltz by email at
          info@phaltz.com.
        </p>
        ...
        <div class="flex items-center my-4">
          <div class="w-1/5 mr-6"><span class="font-bold">Session</span>:</div>
          <div class="w-4/5 ml-6">
            authentication
          </div>
        </div>

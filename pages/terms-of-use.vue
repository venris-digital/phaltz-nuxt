    ...
    <div class="flex justify-center">
      ...
      >
        ...
        <p>
          ...
          terms and conditions), and Phaltz, the owner and operator of this
          ...
          conditions, you should stop using the Website immediately. In these
          terms and conditions, User or Users means any third party that
          accesses the Website and is not either (i) employed by Phaltz and
          acting in the course of their employment or (ii) engaged as a
          consultant or otherwise providing services to Phaltz and accessing the
        ...
        <Subtitle>Intellectual property and acceptable use</Subtitle>
        <p>
          All Content included on the Website, other than personally
          identifiable data uploaded by Users, is the property of Phaltz, our
          ...
          software, data compilations, page layout, underlying code and software
          and any other form of information capable of being stored in a
          computer that appears on or forms part of this Website, including any
          ...
          database rights and other intellectual property rights. Nothing on
          this site shall be construed as granting, by implication, estoppel, or
          otherwise, any license or right to use any trademark, logo or service
          mark displayed on the site without the owner's prior written
          permission You may, for your own personal, non-commercial use only, do
          the following:
        </p>
        ...
        <p>
          ...
          Phaltz. You acknowledge that you are responsible for any Content you
          ...
          may not upload to, distribute or otherwise publish through the Website
          any Content that (i) is confidential, proprietary, false, fraudulent,
          libellous, defamatory, obscene, threatening, invasive of privacy or
          publicity rights, infringing on intellectual property rights, abusive,
          illegal or otherwise objectionable; (ii) may constitute or encourage a
          criminal offence, violate the rights of any party or otherwise give
          ...
          content onto the Website. You represent and warrant that you own or
          otherwise control all the rights to the Content you post; that the
          ...
          injury to any person; and that you will indemnify Phaltz for all
        ...
        <p>
          ...
          ensure we can communicate with you effectively. We may suspend or
          cancel your registration with immediate effect for any reasonable
          purposes or if you breach these terms and conditions. You may cancel
          your registration at any time by informing us in writing to the
          address at the end of these terms and conditions. If you do so, you
          must immediately stop using the Website. Cancellation or suspension of
          your registration does not affect any statutory rights.
        </p>

        <Subtitle>Password and security </Subtitle>
        <p>
          ...
          with anyone. If we have reason to believe that there is or is likely
          to be any misuse of the Website or breach of security, we may require
        ...
        <p>
          ...
          stated, these sites are not under the control of Phaltz or that of our
        ...
        <Subtitle>Privacy Policy and Cookies Policy </Subtitle>
        <p>
          ...
          on the following: link-to-privacy-policy and link-to-cookie-policy.
        </p>

        <Subtitle>Availability of the Website and disclaimers </Subtitle>
        <p>
          Any online facilities, tools, services or information that Phaltz
          ...
          satisfactory quality. Phaltz is under no obligation to update
          information on the Website. Whilst Phaltz uses reasonable endeavours
          to ensure that the Website is secure and free of errors, viruses and
          other malware, we give no warranty or guaranty in that regard and all
          Users take responsibility for their own security, that of their
          personal details and their computers. Phaltz accepts no liability for
          any disruption or non-availability of the Website. Phaltz reserves the
          right to alter, suspend or discontinue any part (or the whole of) the
          Website including, but not limited to, any products and/or services
        ...
        <p>
          ...
          permitted under applicable law. We will not be liable to you in
          respect of any losses arising out of events beyond our reasonable
          control. To the maximum extent permitted by law, Phaltz accepts no
          liability for any of the following:
        </p>

        <ol>
          <li class="my-6">
            1. any business losses, such as loss of profits, income, revenue,
        ...
        <p>
          ...
          be affected. These terms and conditions may be varied by us from time
          to time. Such revised terms will apply to the Website from the date of
          publication. Users should check the terms and conditions regularly to
          ensure familiarity with the then current version. These terms and
          conditions together with the Privacy Policy and Cookies Policy contain
          ...
          might have taken place in relation to the terms and conditions. The
          Contracts (Rights of Third Parties) Act 1999 shall not apply to these
          terms and conditions and no third party will have any right to enforce
          or rely on any provision of these terms and conditions. If any court
          ...
          affected. Unless otherwise agreed, no delay, act or omission by a
          party in exercising any right or remedy will be deemed a waiver of
          that, or any other, right or remedy. This Agreement shall be governed
        ...
        <Subtitle>Phaltz</Subtitle>
        <p>
          You can contact Phaltz by email on info@phaltz.com.
        </p>
...
@Component<TermsOfUse>({
  head(): MetaInfo {
    return { title: `Phaltz: Terms of Use` };
  },
  components: {
    //
  }
